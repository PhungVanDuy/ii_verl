...
dataset = load_dataset("tuenguyen/open-r1-math-220k-chatml")

def remap_messages_system(row):
    ...
    user = messages[0]['content'].replace(system, "")
...
dataset = dataset.map(remap_messages_system, num_proc=16)
