...
from verl.utils.dataset.chat.prompt_tokenizers import PromptTokenizingStrategy
from verl.utils.dataset.chat.chat_template_utils import get_chat_template_from_config
# Configure the logger
LOG = logging.getLogger("verl")
LOG.setLevel(logging.INFO)
IGNORE_TOKEN_ID=-100



class ChatTemplatePrompter:
...
class ChatTemplateStrategy(PromptTokenizingStrategy):
    ...
    def get_conversation_thread(self, prompt):
        ...
        for message in prompt[self.messages]:
            # print(message, self.prompter.message_field_role)
            turn = {
